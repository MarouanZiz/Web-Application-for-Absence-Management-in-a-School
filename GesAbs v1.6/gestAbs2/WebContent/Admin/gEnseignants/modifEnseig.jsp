...
<div class="content">
 ...
 <h4 class="titliste">Gestion des Enseignants > Modifications</h4>
  <form class="fadmin" action="../../miseEnseignant" method="POST">
  ...
  <div class="form-outline mb-4">
                    ...
                    <input type="email" value="${sessionScope.enseignant.getEmail()}" required class="form-control" name="email" />
 ...
 <input type="submit" name="modifer" value="Modifier" style="background-color: #04AA6D" class="btn btn-primary btn-block">

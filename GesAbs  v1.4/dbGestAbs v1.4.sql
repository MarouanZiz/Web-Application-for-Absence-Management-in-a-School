...
--
-- Hôte : 127.0.0.1
-- Généré le : mar. 15 juin 2021 à 00:20
...
(15, 'K256324559', 1, 14, '2021-06-23', 'justifiee'),
...
(19, 'K256324559', 1, 18, '2021-06-09', 'non justifiee'),
(21, 'K256324559', 1, 20, '2021-06-08', 'justifiee'),
(22, 'K256324559', 1, 21, '2021-06-11', 'non justifiee');
...
('S254865266', 'F2555', 'Rajaa', 'Amine', '1998-07-18', 'S254865266@kenitra', 'DBNeaWBb1@JMA9K', NULL, 'H', 'Salé', 1, 1),
...
--
ALTER TABLE `absence`
  MODIFY `idAbs` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `seance`
  MODIFY `idSeance` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

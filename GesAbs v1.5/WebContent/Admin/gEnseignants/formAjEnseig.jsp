...
<a class="active" href="../espaceAdmin.jsp">Acceuil</a>
  ...
  <a href="../logoutAdmin">Déconnexion</a>
   ...
   <div class="col-sm-9">
   		<div class="content">
   		  <h2 Style="background-color: #04AA6D ;padding:20px;width:50%;margin:0 278px ;text-align:center;boder:2px solid black;border-radius:6px;color:white">Ajouter Enseignant</h2>

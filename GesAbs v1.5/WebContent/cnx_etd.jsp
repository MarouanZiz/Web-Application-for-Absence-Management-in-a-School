...
<body>
 <nav class="navbar navbar-expand-lg navbar-light bg-dark">
  ...
  <a class="navbar-brand" style="color:#fff;">Etudiant Login Page</a>
...
<!-- <form action="cnxAdmin" method="POST">
   ...
   <form class="mesForm" action="cnxEtd" method="POST">
           ...
           <b style="color:red">${requestScope.msg}</b>           
            ...
            <button type="submit" class="btn btn-primary btn-block"  style="background-color: #04AA6D ;border:1px solid #04AA6D ">Sign in</button>
          </form>
